...
function createData(number, firstName, lastName, debt, type) {
	return { number, firstName, lastName, debt, type };
}
...
class Partners extends React.Component {
	state = {
		...
		selected: [],
		data: [
			createData(1, 'Joao', 'Cardoso', 120, 'Titular'),
			createData(2, 'Ricardo', 'Ferreira', 120, 'Titular'),
			createData(3, 'Andreia', 'Magalhaes', 120, 'Titular'),
			createData(4, 'Diogo', 'Melo', 120, 'Titular'),
			createData(5, 'Ricardo', 'Coelho', 120, 'Titular'),
			createData(6, 'Miguel', 'Matos', 120, 'Titular'),
			createData(7, 'Antonio', 'Castro', 120, 'Titular'),
			createData(10, 'Helder', 'Pereira', 120, 'Titular'),
			createData(8, 'Paulo', 'Goncalves', 120, 'Titular'),
			createData(9, 'Lucas', 'Monteverde', 120, 'Titular'),
		],
		page: 0,
		rowsPerPage: 6,
	};
